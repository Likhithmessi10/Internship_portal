...
// HOD directly selects from SUBMITTED — shortlisting removed
const NON_STIPEND_TRANSITIONS = {
    [STATUS.SUBMITTED]:           [STATUS.SELECTED, STATUS.REJECTED],
    [STATUS.SHORTLISTED]:         [STATUS.SELECTED, STATUS.REJECTED],   // legacy cleanup path
    [STATUS.SELECTED]:            [STATUS.DOCUMENTS_PENDING, STATUS.REJECTED, STATUS.SUBMITTED],
...
const ROLE_PERMISSIONS = {
    ...
    HOD: [
        ...
        STATUS.APPROVED, STATUS.REJECTED, STATUS.WAITLISTED, STATUS.SUBMITTED
    ],
...
// HOD owns the full pipeline from shortlisting through hiring; PRTI observes and can intervene
const NON_STIPEND_ROLE_PERMISSIONS = {
    HOD:     [STATUS.SHORTLISTED, STATUS.SELECTED, STATUS.DOCUMENTS_PENDING, STATUS.DOCUMENTS_VERIFIED, STATUS.HIRED, STATUS.REJECTED, STATUS.SUBMITTED],
    CE_PRTI: [STATUS.SHORTLISTED, STATUS.SELECTED, STATUS.SUBMITTED, STATUS.DOCUMENTS_PENDING, STATUS.DOCUMENTS_VERIFIED, STATUS.HIRED, STATUS.REJECTED],
