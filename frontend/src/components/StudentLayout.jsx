...
const StudentLayout = ({ children }) => {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
            {/* Navbar */}
            <nav className="glass-navbar border-b-4 border-amber-500 shadow-xl dark:border-amber-600/50">
            ...
            <div className="bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-white/5 shadow-sm sticky top-16 z-30">
