...
import { XCircle, ArrowLeft, Eye, RefreshCw } from 'lucide-react';
            ...
            <div className="glass-card bg-white dark:bg-slate-900/60 border-black/5 dark:border-white/10 rounded-[2.5rem] premium-shadow overflow-hidden transition-all duration-500">
                ...
                {applications.length === 0 ? (
                    <div className="text-center py-20">
                        ...
                        <button onClick={() => navigate('/admin/dashboard')} className="mt-6 inline-flex items-center gap-2 text-indigo-600 dark:text-indigo-400 font-black uppercase tracking-[0.2em] text-xs hover:underline">
                                        ...
                                        <td className="py-5 text-center">
                                            <div className="flex items-center justify-center gap-2">
                                                ...
                                                <button onClick={() => updateStatus(app.id, 'PENDING')}
                                                    className="p-2.5 bg-gray-50 dark:bg-slate-800 hover:bg-amber-600 dark:hover:bg-amber-600 text-gray-400 hover:text-white rounded-xl transition-all shadow-sm border border-gray-200 dark:border-white/5 group/btn"
