...
import { UserPlus, Lock, Mail, AlertCircle, Sun, Moon, Eye, EyeOff } from 'lucide-react';
            ...
            <div className="max-w-5xl w-full bg-white dark:bg-slate-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row-reverse border border-gray-100 dark:border-slate-700 transition-colors duration-200">
                ...
                <div className="md:w-1/2 bg-[#00266b] dark:bg-[#090e17] p-10 lg:p-14 text-white flex flex-col justify-between relative overflow-hidden transition-colors duration-200">
                    ...
                    <div className="relative z-10 flex items-center gap-4 mb-12 justify-end">
                        <div className="text-right">
                            ...
                            <p className="text-xs font-bold tracking-widest text-[#D4A017] uppercase">Internship Program</p>
                        </div>
                    ...
                    <div className="relative z-10 mb-8 text-right">
                        <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-white/10  border border-white/20 mb-6 float-right">
                            <UserPlus className="text-[#D4A017] w-6 h-6" />
                        </div>
                        <div className="clear-both"></div>
                        <h1 className="text-4xl lg:text-5xl font-black font-rajdhani leading-tight mb-4 text-white text-right">
                            Start Your <br /> Journey.
                        </h1>
                        <p className="text-[#aac4e8] dark:text-slate-400 text-sm lg:text-base font-medium ml-auto md:max-w-md">
                    ...
                    <div className="relative z-10 hidden md:block text-right">
                        <p className="text-xs text-[#aac4e8] dark:text-slate-500 font-semibold tracking-wider">STATE TRANSMISSION UTILITY</p>
                    </div>
                </div>
                ...
                <div className="md:w-1/2 p-10 lg:p-14 flex flex-col justify-center bg-white dark:bg-slate-800 relative transition-colors duration-200">
                    <div className="max-w-sm w-full mx-auto">
                        <div className="mb-8">
                            <h2 className="text-2xl font-black text-gray-900 dark:text-white font-rajdhani">
                                Create an Account
                            </h2>
                            <p className="text-gray-500 dark:text-slate-400 text-sm mt-1 font-medium">Please fill in your details to register as a student.</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div>
                                <label className="block text-xs font-bold text-gray-500 dark:text-slate-400 uppercase tracking-widest mb-2">Confirm Password</label>
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                        <Lock className="h-4 w-4 text-gray-400 dark:text-slate-500" />
                                    </div>
                        ...
                        <div className="mt-8 pt-6 border-t border-gray-100 dark:border-slate-700 flex flex-col items-center justify-center gap-3">
                            ...
                            <Link to="/login" className="text-sm font-bold text-[#003087] dark:text-blue-400 hover:text-[#00266b] dark:hover:text-blue-300 transition-colors uppercase tracking-wide">
                                Proceed to Login
                            </Link>
                        </div>
                    </div>
