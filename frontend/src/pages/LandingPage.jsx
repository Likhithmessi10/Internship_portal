        ...
        <div className="lv2-header-inner">
          ...
          <div className="lv2-header-right">
            <div className="lv2-helpdesk">
              ...
              <div className="lv2-helpdesk-row">
              ...
              <p className="lv2-helpdesk-hours">Mon – Fri · 10:00 AM – 5:00 PM</p>
            </div>
            <button className="lv2-theme-icon-btn" onClick={toggleTheme} aria-label="Toggle theme">
