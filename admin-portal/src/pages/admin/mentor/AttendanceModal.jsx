                    ...
                    {attendanceData && (
                        <div className="bg-emerald-50 border border-emerald-100 rounded-2xl p-6">
                            ...
                            <div className="grid grid-cols-3 gap-4 mb-4">
                                ...
                                <div className="text-center">
                                    <p className="text-3xl font-black text-gray-400">{attendanceData.totalDays}</p>
                                    <p className="text-[9px] font-bold text-gray-500 uppercase tracking-widest mt-1">Total Days</p>
                                </div>
                                <div className="text-center">
                                    <p className="text-3xl font-black text-primary">{attendancePercentage}%</p>
                                    <p className="text-[9px] font-bold text-primary uppercase tracking-widest mt-1">Attendance</p>
                                </div>
                            </div>
                            ...
                            <div className="w-full h-3 bg-white rounded-full overflow-hidden border border-emerald-100">
                                <div 
                                    className={`h-full transition-all duration-1000 ${
                                        attendanceData.meetsMinimum ? 'bg-emerald-500' : 'bg-amber-500'
                                    }`}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full p-4 pl-12 bg-surface-container-low border border-outline-variant/30 rounded-2xl text-sm font-bold focus:outline-none focus:ring-4 focus:ring-emerald-100 focus:border-emerald-500 transition-all"
                                />
                            </div>
                        </div>
                                ...
                                <button
                                    ...
                                    className={`p-4 rounded-2xl border-2 transition-all flex items-center justify-center gap-2 ${
                                        present 
                                            ...
                                            : 'bg-white border-outline-variant/20 text-outline hover:border-emerald-300'
                                    }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`p-4 rounded-2xl border-2 transition-all flex items-center justify-center gap-2 ${
                                        !present 
                                            ...
                                            : 'bg-white border-outline-variant/20 text-outline hover:border-red-300'
                                    }`}
                                >
