...
import { Plus, Trash2, Calendar, Folder, Info, Loader2 } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-4">
                    {loading ? (
                        ...
                        batches.map(batch => (
                            <div key={batch.id} className="group bg-surface-container-low p-6 rounded-2xl border border-outline-variant/10 shadow-sm hover:shadow-md transition-all flex items-center justify-between">
                                <div className="flex items-center gap-5">
                                    <div className="w-14 h-14 bg-primary/5 rounded-2xl flex items-center justify-center text-primary border border-primary/5 group-hover:bg-primary group-hover:text-white transition-all">
                                        <Calendar className="w-6 h-6" />
                                    </div>
                                    <div>
                                        <h4 className="text-xl font-bold text-primary tracking-tight">{batch.title}</h4>
                                ...
                                <div className="flex items-center gap-2">
                                    <button 
                                        ...
                                        className="p-3 text-outline/30 hover:text-error hover:bg-error/5 rounded-xl transition-all"
